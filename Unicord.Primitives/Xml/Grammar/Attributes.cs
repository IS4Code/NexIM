...
namespace NexIM.Primitives.Xml.Grammar;
...
[AttributeUsage(AttributeTargets.Interface, AllowMultiple = false, Inherited = false)]
public sealed class NamespaceAttribute(string uri) : Attribute
{
...
public sealed class NameAttribute(string localName, string? namespaceUri = null) : Attribute
{
